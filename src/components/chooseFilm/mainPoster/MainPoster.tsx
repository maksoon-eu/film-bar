                ...
                <div className={styles.mainPoster__content}>
                  <div className={styles.mainPoster__logo}>
                    {item.logo?.url ? (
                      ...
                      <div className={styles.mainPoster__logo_text}>{item.name}</div>
                    )}
                  ...
                  <div className={styles.mainPoster__assets}>
                    <div className={styles.mainPoster__assets_ageRating}>
                      {item.ageRating && (
                        <div className={styles.mainPoster__ageRating}>{item.ageRating}+</div>
                      )}
                      {item.genres?.length && (
                  ...
                  {item.countries?.length && (
                    <div
                      ...
                      <AssetsList list={item.countries.slice(0, 5)} path="countries" />
                    </div>
                  )}

                  {item.description && (
                    <div className={styles.mainPoster__description}>{item.description}</div>
                  )}
                </div>
              </div>
            </div>
